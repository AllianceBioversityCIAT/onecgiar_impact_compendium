...
class StudyImpactArea(Base):
    ...
    id = Column(Integer, primary_key=True)
    study_id = Column(Integer, ForeignKey("studies.id"), nullable=False)
    impact_area_id = Column(
        Integer, ForeignKey("clarisa_impacts_areas.id"), nullable=False
    )
...
class StudyInterventionType(Base):
    ...
    id = Column(Integer, primary_key=True)
    study_id = Column(Integer, ForeignKey("studies.id"), nullable=False)
    intervention_type_id = Column(
        Integer, ForeignKey("intervention_types.id"), nullable=False
    )
