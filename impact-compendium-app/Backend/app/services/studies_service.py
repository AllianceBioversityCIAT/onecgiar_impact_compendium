...
class StudiesService:
    def __init__(self, db: Session):
        self.db = db
        self.cache_enabled = (
            bool(os.getenv("REDIS_URL")) or True
            ...
            "narratives": [
                {
                    ...
                    "content": "This comprehensive study examines the long-term impacts of sustainable agricultural practices on smallholder farmer livelihoods and food security outcomes.",
                },
                {
                    "section_key": "methodology",
                    "content": "We employed a mixed-methods approach combining quantitative surveys with qualitative interviews across multiple sites.",
                },
                {
                    "section_key": "results",
                    "content": "Results demonstrate significant positive impacts on both productivity and sustainability metrics.",
                },
            ],
    ...
    def list_studies(self, **kwargs) -> Dict[str, Any]:
        ...
        items = [
            {
                ...
                "intervention": {
                    "type": "Research Study",
                    "detailsShort": "Sample intervention",
                },
                "contributors": {
                ...
                "indicators_highlight": [
                    {
                        "indicator_measure": "Sample Metric",
                        "unit": "%",
                        "result_reported": f"{85+i}%",
                    }
                ],
                "doi": None,
            }
        ...
        return type(
            "Result",
            (),
            {"items": items, "total": 50, "page": page, "pageSize": pageSize},
        )()
