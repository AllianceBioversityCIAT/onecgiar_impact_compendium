  ...
  return (
    <div className="space-y-1 relative" ref={dropdownRef}>
      ...
      <div className="relative">
        ...
        {isOpen && (
          <div className={`absolute z-50 w-full bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-auto ${
            ...
            {options.map((option) => (
              <div
                ...
                className={`px-3 py-2 cursor-pointer hover:bg-gray-100 ${
                  value === option.value ? 'bg-yellow-50 text-yellow-800' : 'text-gray-900'
                }`}
