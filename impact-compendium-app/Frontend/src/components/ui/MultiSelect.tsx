  ...
  return (
    <div className="space-y-1 relative" ref={dropdownRef}>
      ...
      <div className="relative">
        <div
          ...
          onClick={() => {
            ...
            if (dropdownRef.current) {
              ...
              setDropdownPosition(
                spaceBelow < 250 && spaceAbove > 250 ? 'top' : 'bottom'
              );
            }
            setIsOpen(!isOpen);
          }}
        >
          <div className="flex-1 mr-2">{renderSelectedOptions()}</div>
          <svg
        ...
        {isOpen && (
          <div
            className={`absolute z-10 w-full bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-hidden ${
