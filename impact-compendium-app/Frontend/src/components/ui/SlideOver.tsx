...
export const SlideOver: React.FC<SlideOverProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      />
      <div
        className={`fixed right-0 top-0 h-full w-96 bg-white shadow-xl transform transition-transform duration-500 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
