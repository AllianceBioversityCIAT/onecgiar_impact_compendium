            ...
            <div className="max-w-4xl">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-8 text-center">
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  General settings panel is under development. This will include application preferences, 
                  notification settings, and system configuration options.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-4xl">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Manage security settings and data protection policies</p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-200 rounded-2xl p-8 text-center">
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  Security and privacy controls are being developed. This will include authentication settings, 
                  data encryption options, and privacy policy management.
                </p>
              </div>
            </div>
          </div>
